            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li><a href="admin/index.php"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Booked</span></a></li>
...
//-->
    ...
    <a href="users.php">
        <div id="bar-chart-container" class="col-sm-4">
          <div class="vis-container">Booked Schedules</div>	
        </div>
    </a>
    <a href="verify.php">
        <div id="pie-chart-container" class="col-sm-4">
          <div class="vis-container">Expired schedules</div>
        </div>
    </a>
      </div>
      <div class="row">
      	<a href="recent_matches.php">
        <div id="scatterplot-container" class="col-sm-4">
