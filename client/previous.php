            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li><a href="booked.php"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Booked Sessions</span></a></li>
                        ...
                        <li><a href="previous.php"><i class="fa fa-calendar" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Previous Bookings</span></a></li>
...
//-->
        ...
        <div id="scatterplot-container" class="col-sm-6">
          <div class="vis-container">Trainers</div>
        </div>
    </a>
    <a href="booked.php">
        <div id="bar-chart-container" class="col-sm-6">
          <div class="vis-container">Booked Sessions</div>	
        </div>
    </a>
