            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li><a href="allschedules.php"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">All Schedules</span></a></li>
...
{
    $id = $_GET['id'];
    $sql = "SELECT * FROM `schedules` WHERE trainer_id='$id' AND status='unbooked'";
