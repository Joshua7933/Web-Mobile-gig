          ...
          echo "<div class='panel-heading'>" .$row['trainer_fname']." ".$row['trainer_lname']."</div>";
            echo "<div class='panel-body'><img src='../trainer/".$row['trainer_profilepic']."' width='250px' height='250px' style='border-radius: 50%;'/>";
                ...
                echo "<p>".$row['trainer_shortdesc']."</p>";
                 ...
                 echo "</div>";
                 echo "<div class='panel-footer'><a href='review.php?tid=".$row['trainer_id']."'><button class='btn btn-success   '>Review</button>     <a href='trainersessions.php?id=".$row['trainer_id']."'><button class='btn btn-primary   '>See schedule</button></a></div>";
                 echo "</div>";
               $_SESSION['traid']=$row['trainer_id'];
