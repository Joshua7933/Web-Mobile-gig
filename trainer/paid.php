            ...
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li class="active"><a href="paid.php"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Paid Sessions</span></a></li>
...
//-->
    ...
    <tbody>
        <?php
        include '../con.php';
        $idsession =$_SESSION['trainer_id'];
            $sql = "SELECT * FROM paid WHERE trainer_id='$idsession'";
